...
description: >
  Use when writing or reviewing Kotlin code in a Spring Boot project, especially
  data/sealed classes, null safety, extension/scope functions, companion
  objects, constructor injection, exceptions, tests, JPA/QueryDSL, or
  service-layer design. Triggers: "Kotlin 코드 리뷰", "Spring Boot Kotlin 서비스",
  "nullable 처리", "JPA/QueryDSL 패턴". Do NOT use for Java projects.
metadata:
  origin: ECC
---
