...
>
> **위치 정책** — 작업 문서 5종(PROJECT_OVERVIEW/SOURCE_MAP/DB_SCHEMA/DEPLOY/DESIGN)의 기본 위치는 `docs/`다. 사용자가 명시적으로 다른 디렉토리를 요청하면 그곳에 설치한다. LESSONS.md와 스킬 3종은 위치 고정. 어디에 설치하든 CLAUDE.md "문서 매핑" 표에는 **실제 경로 그대로** 기록한다.
